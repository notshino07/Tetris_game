...
public class JuegoTetris extends Game {
    ...
    private static class PantallaServidor extends ScreenAdapter implements ControladorJuego {
        ...
        private PantallaServidor(JuegoTetris juego) {
            // Se mantiene el constructor para compatibilidad con la llamada.
        }
